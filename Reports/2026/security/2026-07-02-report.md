...
This month was focused on supply chain and measurements included below, and maintainance about the email addresses used to reach us and PGP keys. A few fixes. Issues in triage are stacking up and I need to priorize this for the beginning of July.
...
- Removed PGP keys from all documentations since the private key is lost. 
...
- Bi-weekly security meetings attented: June 2, 16, 30
